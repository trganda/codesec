...
public class MozillaRhinoBadAttributeValueExpExceptionExec {
    ...
    public static void main(String[] args) throws Exception {
        ObjectOutputStream oos =
                new ObjectOutputStream(Files.newOutputStream(Paths.get("target/MozillaRhinoBadAttributeValueExpExceptionExec.bin")));
        oos.writeObject(getObject());

        ObjectInputStream ois =
                new ObjectInputStream(Files.newInputStream(Paths.get("target/MozillaRhinoBadAttributeValueExpExceptionExec.bin")));
        ois.readObject();
    }
}
